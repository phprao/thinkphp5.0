 ...
 */
class PartnerAccountModel extends Model
{
    /**
     * @var string
     */
    public $table = 'dc_partner_account';
    ...
    {
       return  $this->where('account_partner_id',$agentId)->find();
    }
    /**
     * 更新代理商的账号信息
     * @param $agentId
    ...
    {
        return $this->where('account_partner_id',$agentId)->update($data);
    }
    ...
    {
        $this->data([
            'account_partner_id' =>$info['partner_id']
        ]);
        $this->save();
